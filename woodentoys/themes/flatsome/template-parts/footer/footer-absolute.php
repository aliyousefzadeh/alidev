  ...
  <div class="container clearfix">
    ...
    <div class="footer-primary pull-left">
      ...
      <div class="copyright-footer">
        <?php echo do_shortcode( get_theme_mod( 'footer_left_text', 'برای استفاده از مطالب الیکاوود، داشتن «هدف غیرتجاری» و ذکر «منبع» کافیست. تمام حقوق اين وب‌سايت نیز برای فروشگاه آنلاین الیکاوود است.  [ux_current_year] &copy; <strong>https://t.me/hosseinyousefzadeh</strong>' ) ); ?>
      </div>
